...
Windows) for settings, and ~/.local/share/HeadsetBatteryIndicator
for logs.
"""
...
if PORTABLE:
    ...
    LOG_FILE = os.path.join(APP_DIR, "HeadsetBatteryIndicator.log")
else:
    APP_DIR = None
    SETTINGS_FILE = None
    LOG_FILE = os.path.join(
        os.path.expanduser("~"),
        ".local", "share", "HeadsetBatteryIndicator", "HeadsetBatteryIndicator.log",
    )
